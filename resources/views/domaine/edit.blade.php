...
<div class="center">
    ...
    <div class="col-md-5 col-md-offset-4">
        ...
        <form action="{{route('domaine.update')}}" method="post">
            @csrf
            <input type="hidden" name="id" value="{{$domaine->id}}">
            <div class="form-group">
                <label>Nom</label>
                <input type="text" class="form-control" name="titre" id="chapitre" placeholder="Entrez le nom" value="{{$domaine->titre}}">
                <span class="text-danger">@error('titre') {{$message}} @enderror</span>
            </div>
            <div class="modal-footer">
                <a href="/domaine/add/{{$domaine->chapitre_id}}" class="btn btn-light">Retour</a>
