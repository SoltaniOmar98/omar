...
<div class="center">
    <table class="table">
        ...
        <tr>
            ...
            <td>
                <form action="{{ url('/reference/search') }}" method="get">
    ...
    <table class="table">
        ...
        <tr>
            <td>{{$ref->titre}}</td>
            <td><a href="/critere/add/{{$ref->id}}"><img src="https://img.icons8.com/flat-round/24/000000/right--v1.png" /></a></td>
            <!--Go to add Référence-->
            <td><a href="/reference/edit/{{$ref->id}}"><img src="https://img.icons8.com/android/24/000000/edit.png" /></a></td>
            <!--Update Domaine-->
            <td><a href="" data-ref_id="{{$ref->id}}" data-bs-toggle="modal" data-bs-target="#deleteModal"><img src="https://img.icons8.com/plasticine/24/000000/filled-trash.png" /></a></td>
            <!--Delete Domaine-->
    ...
    <div class="col-md-5 col-md-offset-4">
        <form action="{{ route('reference.save')}}" method="POST">
            ...
            <div class="col-auto">
                ...
                <input type="text" class="form-control" name="titre" placeholder="Entrez titre de domaine " value="{{old('titre')}}">
